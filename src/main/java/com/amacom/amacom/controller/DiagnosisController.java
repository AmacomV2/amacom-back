...
public class DiagnosisController {
    ...
    public ResponseEntity<DiagnosisDTO> create(
        ...
        diagnosis.setPersonSituation(this.personSituationService.getEntityFromUUID(diagnosisDTO.getIdPersonSituation()));

        var diagnosisBD = this.diagnosisService.create(diagnosis);
        if(diagnosisBD == null) return new ResponseEntity<>(HttpStatus.CONFLICT);
