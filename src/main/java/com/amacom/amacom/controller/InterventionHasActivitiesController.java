...
public class InterventionHasActivitiesController {
    ...
    public ResponseEntity<InterventionHasActivitiesDTO> findById(
        ...
        return new ResponseEntity<>(
                InterventionHasActivitiesMapper.INSTANCE.toInterventionHasActivitiesDTO(interventionHasActivities),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<InterventionHasActivitiesDTO> create(
        ...
        interventionHasActivities.setIntervention(
                this.interventionService.getEntityFromUUID(interventionHasActivitiesDTO.getIdIntervention()));
        interventionHasActivities
                .setActivity(this.activityService.getEntityFromUUID(interventionHasActivitiesDTO.getIdActivity()));
        ...
        return ResponseEntity.ok(
                InterventionHasActivitiesMapper.INSTANCE.toInterventionHasActivitiesDTO(interventionHasActivitiesBD));
    }
